...
public class BishopTest {
    ...
    public static void setup() {
        try {
            moveStrategyMethod = Bishop.class.getDeclaredMethod("moveStrategy", int.class, int.class, MoveStrategy.class);
            getPossibleMoveFieldsMethod = Bishop.class.getDeclaredMethod("getPossibleMoveFields");
    ...
    public void testGetPossibleMoveFields() throws ReflectiveOperationException {
        ...
        executionHandler.substituteMethod(DiagonalMover.class.getDeclaredMethod("getDiagonalMoves"), invocation -> points);
